...
//   const { inputId, id, htmlFor, text, isSelected, value, handleChangeProp } =
//     props
...
//   const { id, formId, label, cssClass, inputs, choices, size } = field
//   const checkboxInputs = choices?.map((choice, index) => ({
//     ...choice,
//     id: inputs?.[index]?.id,
//   }))
...
//       }
//       if (!checked) {
//         const updatedBoxes = checkboxValue.filter(
//           item => box.value !== item.value
//         )
